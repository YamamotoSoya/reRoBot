# claude: 3D LiDAR + IMU 構成ラッパ (2026-08-10)。実体は rerobot_bringup.launch.py。
#   固定: lidar_2d=false, lidar_3d=true, imu=true
#   接続系引数 (device_ip / rps / model / imu_port 等) はそのまま透過する。
#   GLIM の IMU ありモード / LIO-SAM の入力側になる構成。
import os
