...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'enable_color',                 'default': 'false', 'description': 'enable color stream'},  # claude: IMU専用のため無効化
                           {'name': 'rgb_camera.color_profile',     'default': '0,0,0', 'description': 'color stream profile'},
                           {'name': 'rgb_camera.color_format',      'default': 'RGB8', 'description': 'color stream format'},
                           {'name': 'rgb_camera.enable_auto_exposure', 'default': 'true', 'description': 'enable/disable auto exposure for color image'},
                           {'name': 'enable_depth',                 'default': 'false', 'description': 'enable depth stream'},  # claude: IMU専用のため無効化
                           {'name': 'enable_infra',                 'default': 'false', 'description': 'enable infra0 stream'},
                           {'name': 'enable_infra1',                'default': 'false', 'description': 'enable infra1 stream'},  # claude: IMU専用のため無効化
                           {'name': 'enable_infra2',                'default': 'false', 'description': 'enable infra2 stream'},  # claude: IMU専用のため無効化
                           ...
                           {'name': 'depth_module.emitter_enabled',     'default': 'false', 'description': 'enable/disable IR emitter'},
                           ...
                           {'name': 'enable_sync',                  'default': 'false', 'description': "'enable sync mode'"},  # claude: 映像フレーム同期は不要
                           {'name': 'depth_module.inter_cam_sync_mode',               'default': "0", 'description': '[0-Default, 1-Master, 2-Slave]'},
                           {'name': 'enable_rgbd',                  'default': 'false', 'description': "'enable rgbd topic'"},  # claude: IMU専用のため無効化
                           ...
                           {'name': 'align_depth.enable',           'default': 'false', 'description': 'enable align depth filter'},  # claude: depth無効のため後段のalignも無効化
...
def launch_setup(context, params, param_name_suffix=''):
    ...
    # Load lifecycle nodes setting from realsense2_camera's installed config
