...
| 3D LiDAR | Sure-Star R-Fans-16 = **V6K-16G GM 格式** (Ethernet 192.168.0.3, `surestar_rfans_ros2` — 08-14 刷新) | frame `rfans`, PointCloud2 `/rfans_driver/rfans_points` (旧 `/sdk_could` は廃止) |
